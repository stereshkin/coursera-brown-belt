...
Node* Next(Node* me) {
    if (me->right == nullptr and me->parent != nullptr) {
        auto parent = me->parent;
        if (parent->value > me->value) {
            return parent;
        }
        else {
            while (parent->value < me->value) {
    ...
    else if (me->parent == nullptr and me->right == nullptr and me->left != nullptr) {
        auto current = me->left;

        while (true) {
            if (current->value < me->value) {
                current = current->right;
            }
            if (current->value > me->value and current->left != nullptr) {
    ...
    else if (me->right == nullptr and me->left == nullptr and me->parent == nullptr) return nullptr;

    else if (me->right != nullptr ) {
        auto current = me->right;
        while (true) {
            if (current->value < me->value) {
                current = current->right;
            }
